...
const fetch_todoist = function () {
  ...
  const todos = sortDB(todo_db).map((todo) => {
    return `<div
      id="task"
      class="group flex flex-row items-center justify-between border-b border-[1px] hover:bg-blue-500 hover:text-white p-3 m-2"
    >
...
const deleteTodo = function (id) {
  Swal.fire({
    ...
    text: 'Are you sure you want to delete todo list?',
    icon: 'warning',
